...
class SetCriterion(nn.Module):
    ...
    def forward(self, outputs, targets, aux_losses):
        ...
        """
        outputs_without_aux = {k: v for k, v in outputs.items() if 'aux' not in k}      # 保留最后一层输出

        # Retrieve the matching between the outputs of the last layer and the targets
        indices = self.matcher(outputs_without_aux, targets)        # 匹配预测与真实框
